        ...
        return (
            <div style={{display: 'inline-block'}}>
                <div style={_.assign({}, { display: 'inline-block', width: 16, height: 16, lineHeight: '16px', borderRadius: '50%', textAlign: 'center', color: '#fff', position: 'relative' }, this.state.showTip ? { backgroundColor: colorsMap.C08 } : {
                    ...
                    <p className='tip-block' style={_.assign({},{color: colorsMap.C12, position: 'absolute', top: 26, right: '50%', marginRight: -130, whiteSpace: 'normal'}, this.state.showTip ? {display: 'block'} : {display: 'none'})}>
                    {
                        this.props.content
                    }
                    </p>
