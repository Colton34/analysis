...
function getDS(examPapersInfo, examStudentsInfo, studentsGroupByClass, allStudentsPaperMap, currentClass) {
    ...
    _.each(examPapersInfo, (paperObj, pid) => {
        ...
        // debugger;
        var gradeQuestionSeparation = getGradeQuestionSeparation(paperObj.questions, pid, allStudentsPaperMap, targetCount, betterStudents, worseStudents, allStudentsPaperQuestionInfo);
        result[pid] = {
...
//Note:通过question中是否有[xb_answer_pic]来确定是主观题还是客观题
function getGradeQuestionSeparation(questions, pid, allStudentsPaperMap, targetCount, betterStudents, worseStudents, allStudentsPaperQuestionInfo) {
...
//TODO:不对，应该是跟着“考试这场科目的考生”而不是“这场考试所有的考生”
    return _.map(questions, (questionObj, index) => {
        var spearation;
        //TODO: 计算的方式是否正确？
        if(questionObj['[xb_answer_pic]']) {
            //主观题
