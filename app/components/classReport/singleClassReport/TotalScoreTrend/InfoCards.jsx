...
export default function InfoCards ({headerData}) {
    ...
    return (
        <div style={{marginTop: 30}}>
           <Card style={{marginRight: 20}} num={headerData.maxScore} desc={'总分最高分'} numStyle={{color: colorsMap.B04}}/>
           <Card style={{marginRight: 20}} num={headerData.minScore} desc={'总分最低分'} numStyle={{color: colorsMap.B08}}/>
