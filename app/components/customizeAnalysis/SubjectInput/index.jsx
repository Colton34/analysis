            ...
            <div>
                <div className={ownClassNames.content}>
                    <div style={{ marginBottom: 12 }}>
                        ...
                        <input ref='subjectName' defaultValue={this.props.currentSubject.name ? this.props.currentSubject.name : ''} className={ownClassNames['fx-input']} type="text" placeholder="填写你想分析的学科" />
                    </div>
