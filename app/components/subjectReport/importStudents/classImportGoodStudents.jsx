...
export default function ClassImportGoodStudents({currentPaperStudentsInfo}) {
...
function getBetterStudent(currentPaperStudentsInfo){
     var allStudent = _.takeRight(currentPaperStudentsInfo,_.round(_.size(currentPaperStudentsInfo)*0.2))//前20
