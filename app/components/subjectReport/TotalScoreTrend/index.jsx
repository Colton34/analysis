...
function getSummaryInfo(currentPaperStudentsInfo) {
    ...
    if(skewness < -0.3) {
        ...
        return '以全年级学科平均分来衡量，这次考试全年级高于平均分的学生人数比平均分以下学生人数稍少一点，相应低分段学生人数密度稍大一些。但是高分度学生的总分水平比较给力，他们对全年级学科平均分的提高有较大贡献。';
    } else  return '以全年级总分平均分来衡量，这次考试全年级低于平均分的学生人数较多，相应高分段学生人数密来的较小。但是高分度学生的总分水平很给力，他们对去全年级学科平均分的保持较高水平有极大贡献。';
