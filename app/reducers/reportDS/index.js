...
* @Last Modified time: 2016-08-26 11:27:10
*/
...
export default function reducer(state, action) {
    ...
    switch(action.type) {
        ...
        case CHANGE_LEVEL:
            ...
            return state.set('levels', Map(action.data.levels)).set('subjectLevels', Map(action.data.subjecLevels)).set('levelBuffers', List(newLevelBuffers)).set('forseUpdate', !state.forseUpdate);
